<template>
  ...
  <v-img class="pa-2 " tile src="../assets/img/bienvenido.png" width="70%"></v-img>
   ...
   <v-col cols="12" sm="6" md="4" class="mt-13" >
    ...
    mdi-email-outline
              ...
              <v-text-field v-model="password" :counter="20"  color="#31A1AC"  type="password" label="Password" required @keypress.enter="validate"> <v-icon
      slot="append"
      color="#31A1AC"
    >
   mdi-key-variant
       ...
       <v-row class="justify-center mt-12 d-sm-block d-md-inline-flex">
           <v-col cols="12" sm="12" md="6"  >
                <v-btn   color="#31A1AC"  outlined class="mt-4 mr-4"  x-large  @click="register">Registrar</v-btn>
              <!-- <v-btn color="success" class="mt-4 mr-4" @click="validate">Iniciar</v-btn> -->
                  
           </v-col>
           <v-col cols="12" sm="12" md="6"  >
                      <v-btn class=" mt-4 mr-4" color="#31A1AC" x-large  @click="validate"  dark>  <v-icon left>mdi-login</v-icon>Iniciar sesión</v-btn>
